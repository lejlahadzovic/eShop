...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShop.Services.Database.Dobavljaci", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.IzlazStavke", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.Izlazi", b =>
                {
                    b.Property<int>("IzlazId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.JediniceMjere", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.Korisnici", b =>
                {
                    b.Property<int>("KorisnikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.KorisniciUloge", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.Kupci", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.NarudzbaStavke", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.Narudzbe", b =>
                {
                    b.Property<int>("NarudzbaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.Ocjene", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.Proizvodi", b =>
                {
                    b.Property<int>("ProizvodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.Skladistum", b =>
                {
                    b.Property<int>("SkladisteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.UlazStavke", b =>
                {
            ...
            modelBuilder.Entity("eShop.Services.Database.Ulazi", b =>
                {
                    b.Property<int>("UlazId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.Uloge", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.VrsteProizvodum", b =>
                {
                    b.Property<int>("VrstaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eShop.Services.Database.IzlazStavke", b =>
                {
                    b.HasOne("eShop.Services.Database.Izlazi", "Izlaz")
                        .WithMany("IzlazStavkes")
                        .HasForeignKey("IzlazId")
                        .IsRequired()
                        .HasConstraintName("FK_IzlazStavke_Izlazi");

                    b.HasOne("eShop.Services.Database.Proizvodi", "Proizvod")
                        .WithMany("IzlazStavkes")
            ...
            modelBuilder.Entity("eShop.Services.Database.Izlazi", b =>
                {
                    b.HasOne("eShop.Services.Database.Korisnici", "Korisnik")
                        .WithMany("Izlazis")
                        .HasForeignKey("KorisnikId")
                        .IsRequired()
                        .HasConstraintName("FK_Izlazi_Korisnici");

                    b.HasOne("eShop.Services.Database.Narudzbe", "Narudzba")
                        .WithMany("Izlazis")
                        .HasForeignKey("NarudzbaId")
                        .HasConstraintName("FK_Izlazi_Narudzbe");

                    b.HasOne("eShop.Services.Database.Skladistum", "Skladiste")
                        .WithMany("Izlazis")
            ...
            modelBuilder.Entity("eShop.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasOne("eShop.Services.Database.Uloge", "Uloga")
                        .WithMany("KorisniciUloges")
            ...
            modelBuilder.Entity("eShop.Services.Database.Narudzbe", b =>
                {
                    b.HasOne("eShop.Services.Database.Kupci", "Kupac")
                        .WithMany("Narudzbes")
            ...
            modelBuilder.Entity("eShop.Services.Database.Proizvodi", b =>
                {
                    b.HasOne("eShop.Services.Database.JediniceMjere", "JedinicaMjere")
                        .WithMany("Proizvodis")
                        .HasForeignKey("JedinicaMjereId")
                        .IsRequired()
                        .HasConstraintName("FK_Proizvodi_JediniceMjere");

                    b.HasOne("eShop.Services.Database.VrsteProizvodum", "Vrsta")
                        .WithMany("Proizvodis")
            ...
            modelBuilder.Entity("eShop.Services.Database.UlazStavke", b =>
                {
                    ...
                    b.HasOne("eShop.Services.Database.Ulazi", "Ulaz")
                        .WithMany("UlazStavkes")
            ...
            modelBuilder.Entity("eShop.Services.Database.Ulazi", b =>
                {
                    b.HasOne("eShop.Services.Database.Dobavljaci", "Dobavljac")
                        .WithMany("Ulazis")
